...
import burger1 from "../assets (2)/burger1.png";
import burger2 from "../assets (2)/burger2.png";
import pizza1 from "../assets (2)/pizza1.png";
import pizza2 from "../assets (2)/pizza2.png";
import cupcake1 from "../assets (2)/cupcake1.png";
import cupcake2 from "../assets (2)/cupcake2.png";
import icecream1 from "../assets (2)/icecream1.png";
import icecream2 from "../assets (2)/icecream2.png";
        ...
        flex flex-col md:flex-col lg:flex-row items-center gap-8">
            ...
            <div className="w-full lg:w-3/4 flex flex-col items-center">
                ...
                <div className="mt-4 md:mt-6 flex items-center space-x-3 md:space-x-4 lg:space-x-6">
                    ...
                    <div className="flex items-center justify-center p-2 md:p-3 bg-white rounded-full 
                    shadow-xl transform transition hover:scale-110">
                        <FaShareAlt className="text-red-500" size={20} />
                    </div>
                </div>
            </div>
        </div >
